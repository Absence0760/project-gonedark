...
| Audio fidelity (a primary system, #6) | ⏳ designed cue set landed (D99) | Delta Force | **LAG (closing)** | **CP-6** music bed + stingers still owed |
...
- **CP-6 — Audio identity pass.** Replace procedural placeholders ([D26](../decisions.md)/[D29](../decisions.md))
  ...
  *Designed cue set landed ([D99](../decisions.md)): all eight cues are seed-scripted Csound+SoX
