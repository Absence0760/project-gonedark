...
- [x] Match-setup / skirmish-entry screen (Phase 4) — designed in [`modes.md`](modes.md) §3; step 1
  ...
  the standing battles, booted via `seed_positioned_skirmish`). Target-model remainder, not a
  blocker: picker preview/metrics; baked/generated maps join when the D77 loader lands
