...
timeline presentation shipped on desktop as the navigable conflict atlas
([D104](decisions.md)), which now opens each war onto its **battlefield overview** — the
globe zoomed to that war's ground, one progress-toned pin per battle ([D106](decisions.md)),
