...
| [`docs/tank-embodiment-plan.md`](docs/tank-embodiment-plan.md) | Tank-embodiment plan (PLAN — D55) — War Thunder-flavoured embodied tank: independent hull/turret, all-unit armour facing, dispersion gunnery; fixed-point/lockstep phasing P1–P8 |
