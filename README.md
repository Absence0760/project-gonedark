...
| [`docs/plans/combat-rebalance-plan.md`](docs/plans/combat-rebalance-plan.md) | Combat rebalance plan (PLAN — [Q18](docs/open-questions.md)) — restore the Rifleman/Heavy rock-paper-scissors and make suppression bite at the new lethal speed ([D66](docs/decisions.md)/[D67](docs/decisions.md)); faction-independent, shippable now |
