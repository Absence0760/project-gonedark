...
| [`docs/plans/combat-rebalance-plan.md`](docs/plans/combat-rebalance-plan.md) | Combat rebalance plan ([Q18](docs/open-questions.md)) — restore the Rifleman/Heavy rock-paper-scissors (WS-A **landed**: Heavy 280→300 HP, 90→100 dmg, harness-confirmed) and make suppression bite at the new lethal speed (WS-B pending); gated prerequisite for the factions build |
