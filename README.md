...
| `.github/` | CI workflows (build, test, determinism, audit, gitleaks, terraform, CodeQL, Scorecard), the grouped Dependabot config, and the PR / issue templates — the PR template's checklist is the [non-negotiable invariants](CLAUDE.md#non-negotiable-invariants) in tickable form |
