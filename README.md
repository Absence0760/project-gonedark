...
| [`docs/modes.md`](docs/modes.md) | Game modes — Campaign / Skirmish / PvP as three distinct front doors over one match engine; the skirmish map/army/difficulty setup flow; the PvP meta (army select, per-queue map pools + symmetry gate, matchmaking/ranking + determinism-backed result verification; rating model open as [Q29](docs/open-questions.md)) |
