...
| [`docs/playability-plan.md`](docs/playability-plan.md) | Playability push (IN PROGRESS) — six parallel-worker workstreams to make the game *play* and *read* like a game: embodied combat, win/lose, enemy AI, in-match text, embodied FPS world, command-view polish |
