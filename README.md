...
| [`docs/plans/tank-embodiment-plan.md`](docs/plans/tank-embodiment-plan.md) | Tank-embodiment plan (PLAN — D55) — War Thunder-flavoured embodied tank: independent hull/turret, all-unit armour facing, dispersion gunnery; fixed-point/lockstep phasing P1–P9 (P1–P3 landed: trig slew math, hull/turret heading, ballistic projectile pool) |
